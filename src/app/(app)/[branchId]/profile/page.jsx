          ...
          <label className="flex flex-col">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl border bg-white/90 px-3 py-2 pr-11 shadow-sm outline-none transition focus:ring-2"
                style={{ borderColor: BRAND.soft, color: BRAND.text }}
                value={form.password}
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex items-center justify-center px-3 transition-colors hover:opacity-80"
